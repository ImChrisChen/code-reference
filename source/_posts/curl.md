...
| command                                                               | description                         |
| :-------------------------------------------------------------------- | :---------------------------------- |
| `curl -I https://code-reference.dev`                                     | `curl` sends a request              |
| `curl -v -I https://code-reference.dev`                                  | `curl` request with details         |
| `curl -X GET https://code-reference.dev`                                 | use explicit http method for `curl` |
| `curl --noproxy 127.0.0.1 http://www.stackoverflow.com`               | `curl` without http proxy           |
| `curl --connect-timeout 10 -I -k https://code-reference.dev`             | `curl` has no timeout by default    |
| `curl --verbose --header "Host: www.mytest.com:8182" code-reference.dev` | `curl` get extra header             |
