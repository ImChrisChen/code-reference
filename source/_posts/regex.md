...
- [Regex in Python](#regex-in-python) _(code-reference.dev)_
- [Regex in JavaScript](#regex-in-javascript) _(code-reference.dev)_
- [Regex in PHP](#regex-in-php) _(code-reference.dev)_
- [Regex in Java](#regex-in-java) _(code-reference.dev)_
- [Regex in MySQL](#regex-in-mysql) _(code-reference.dev)_
- [Regex in Vim](/vim#search-and-replace) _(code-reference.dev)_
- [Regex in Emacs](/emacs#search) _(code-reference.dev)_
